    ...
    */
    ...
    [
                ...
                'submenu' => [
                  ...
                  [
                      'text' => 'Exibir Categorias',
                      'url'  => 'exibircategoria',
                      'icon' => 'fas fa-fw fa-tv',
                      'icon_color' => 'purple',
                  ],
                  [
                      'text' => 'Exibir Fornecedor',
                      'url'  => 'exibirfornecedor',
                      'icon' => 'fas fa-fw fa-tv',
                      'icon_color' => 'purple',
                  ],
